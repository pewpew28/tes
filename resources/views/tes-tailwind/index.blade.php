            ...
            <div x-data="{
                ...
                <div class="absolute w-full flex justify-center p-4 border-2">
                    <template x-for="slide in slides" :key="slide.id">
                        <div class="h-64 transition-opacity duration-3000 "
                            :class="{
                                'opacity-100 scale-110 transition-transform -translate-y-6 w-full': activeSlide ===
                                    slide
                                    .id,
